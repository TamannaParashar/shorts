    ...
    <div className="flex items-center justify-center p-4">
      <Card className="w-full max-w-md bg-gray-600 border-gray-800">
        ...
        <CardContent className="space-y-6">
          ...
          <div>
            <CardTitle className="text-2xl font-bold text-white text-center m-5" style={{textShadow:'2px 3px 2px #2563eb'}}>Welcome User</CardTitle>
            ...
            <div className="space-y-6">
              <div className="text-center space-y-4">
                ...
                <div>
                  <h2 className="text-xl font-semibold text-white" style={{textShadow:'2px 3px 2px #2563eb'}}>Welcome back, {session.user?.name}!</h2>
                </div>
              </div>
              ...
              <Button
                onClick={() => signOut()}
                variant="outline"
                className="w-full border-gray-700 bg-gray-800 hover:bg-gray-700 text-white font-bold py-3 transition-colors duration-200"
                size="lg"
              >
